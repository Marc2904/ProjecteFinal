document.addEventListener("DOMContentLoaded", async () => {
        ...
        matches.forEach(match => {
            ...
            card.innerHTML = `
                <div class="card shadow rounded-4 p-3 h-100">
                    ...
                    <p class="text-muted text-center mb-1">${new Date(match.match_date).toLocaleString("ca-ES", { dateStyle: "short", timeStyle: "short" })}</p>
                    <p class="text-center"><span class="badge bg-success">${match.round}</span></p>
                </div>
            `;
    ...
    // Recuperar dades de localStorage
